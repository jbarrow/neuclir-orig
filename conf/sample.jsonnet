    ...
    datasets: {
      train: {
        ...
        docs: [
          ...
          pathify([base['tl'], ds, 'text/mt_store/umd-smt-v2.4_sent-split-v3.0', '*.txt']) for ds in
            ['DEV', 'ANALYSIS1', 'ANALYSIS2']
        ] + [
          pathify([base['tl'], ds, 'audio/mt_store/umd-smt-v2.4_material-asr-tl-v5.0', '*.txt']) for ds in
            ['DEV', 'ANALYSIS1', 'ANALYSIS2']
        ]
      },
      validation: {
