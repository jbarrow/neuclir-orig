# options
local output = "datasets/english_multinorm";
# base path
local base = {
...
local tl_q1_da = "tl_dev_analysis_q1/query-analyzer-umd-v10.3_matching-umd-v11.1_evidence-combination-v12.0/TL_QUERY1_DEV_ANALYSIS1_ANALYSIS2_DBQT_PSQ_UMDSMT_SMTsrc_SMTsrp_UMDNMT_UMDNMTsrf_UMDNMTsrc_EdiNMTsr_EdiNMTsrf_Cutoff2";
local tl_q2q3_da = "tl_dev_analysis_q2q3/query-analyzer-umd-v10.3_matching-umd-v11.1_evidence-combination-v12.0/TL_QUERY2QUERY3_DEV_ANALYSIS1_ANALYSIS2_DBQT_PSQ_UMDSMT_SMTsrc_SMTsrp_UMDNMT_UMDNMTsrf_UMDNMTsrc_EdiNMTsr_EdiNMTsrf_Cutoff2";
  ...
  datasets: {
    train: {
      ...
      judgements: [
        ...
        pathify([base['tl'], p, 'query_annotation.tsv']) for p in
          ['DEV_ANNOTATION1', 'ANALYSIS_ANNOTATION1', 'ANALYSIS_ANNOTATION2', 'ANALYSIS_ANNOTATION3']
      ],
      queries: [
        pathify([base['sw'], 'query_store/query-analyzer-umd-v10.3', p, '*']) for p in
          ['QUERY1', 'QUERY2', 'QUERY3']
      ] + [
        pathify([base['tl'], 'query_store/query-analyzer-umd-v10.3', p, '*']) for p in
          ['QUERY1', 'QUERY2', 'QUERY3']
      ],
      docs: [
        pathify([base['sw'], ds, 'text/mt_store/umd-smt-v2.4_sent-split-v3.0', '*.txt.trans']) for ds in
          ['DEV', 'ANALYSIS1', 'ANALYSIS2', 'EVAL1', 'EVAL2', 'EVAL3']
      ] + [
        pathify([base['sw'], ds, 'audio/mt_store/umd-smt-v2.4_material-asr-sw-v5.0', '*.txt.trans']) for ds in
          ['DEV', 'ANALYSIS1', 'ANALYSIS2', 'EVAL1', 'EVAL2', 'EVAL3']
      ] + [
        pathify([base['tl'], ds, 'text/mt_store/umd-smt-v2.4_sent-split-v3.0', '*.txt.trans']) for ds in
          ['DEV', 'ANALYSIS1', 'ANALYSIS2']
      ] + [
        pathify([base['tl'], ds, 'audio/mt_store/umd-smt-v2.4_material-asr-tl-v5.0', '*.txt.trans']) for ds in
          ['DEV', 'ANALYSIS1', 'ANALYSIS2']
      ]
    },
    validation: {
      ...
      judgements: [pathify([base['so'], 'DEV_ANNOTATION2', 'query_annotation.tsv'])],
      queries:    [pathify([base['so'], 'query_store/query-analyzer-umd-v10.3/QUERY1', '*'])],
      docs: [
        pathify([base['so'], 'DEV/text/mt_store/umd-smt-v2.4_sent-split-v3.0', '*.txt.trans']),
        pathify([base['so'], 'DEV/audio/mt_store/umd-smt-v2.4_material-asr-so-v7.0/', '*.txt.trans'])
      ]
    },
  },
