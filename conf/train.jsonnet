...

{
  ...
  model: {
    ...
    doc_field_embedder: Embedder(Pathify('data/embeddings/bivec_100.so.txt'), embedding_dims),
    document_transformer: EmbeddingTransformer(embedding_dims),

    query_field_embedder: Embedder(Pathify('data/embeddings/bivec_100.en.txt'), embedding_dims),
